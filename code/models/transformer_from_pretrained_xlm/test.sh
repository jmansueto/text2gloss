...
DATA="/home/lukebabbitt/text2gloss/code/data/test_data/clean/"
SRC_LANG='en'
TGT_LANG='asl'

#By default it creates a file called generate-test.txt
RESULTS_PATH='/home/lukebabbitt/text2gloss/code/models/basic_transformer/results' 

MODEL_PATH='/home/lukebabbitt/text2gloss/code/models/basic_transformer/checkpoints/checkpoint_best.pt'
N_HYPOTHESES=1
...
BPE_CODES="/home/lukebabbitt/text2gloss/code/data/test_data/bpe_codes.txt" #BPE model of the source language
