...
RESULTS_PATH='/home/jennamansueto/text2gloss/code/models/transformer_tiny/results' 

MODEL_PATH='/home/jennamansueto/text2gloss/code/models/transformer_tiny/checkpoints/checkpoint_best.pt'
N_HYPOTHESES=1
...
BPE_CODES="/home/jennamansueto/text2gloss/code/data/aslg_pc12/bpe_codes.txt" #BPE model of the source language
