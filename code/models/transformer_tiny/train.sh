...
LOG_DIR="${LOG_ROOT_DIR}/transformer_tiny"
...
ARCHITECTURE='transformer_tiny' #Basic transformer
LEARNING_RATE=5e-4 
MAX_TOKENS=2048 #Maximum number of tokens in a sentence

SAVE_DIR='/home/jennamansueto/text2gloss/code/models/transformer_tiny/checkpoints/'
